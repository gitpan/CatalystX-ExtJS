...
BEGIN {
  $CatalystX::Controller::ExtJS::Direct::Route::VERSION = '1.110000';
}
...
BEGIN {
  $CatalystX::Controller::ExtJS::Direct::Route::Chained::VERSION = '1.110000';
}
use Moose::Role;
...
BEGIN {
  $CatalystX::Controller::ExtJS::Direct::Route::REST::VERSION = '1.110000';
}
use Moose::Role;
...
BEGIN {
  $CatalystX::Controller::ExtJS::Direct::Route::REST::ExtJS::VERSION = '1.110000';
}
use Moose::Role;

package CatalystX::Controller::ExtJS::Direct::Route::Factory;
BEGIN {
  $CatalystX::Controller::ExtJS::Direct::Route::Factory::VERSION = '1.110000';
}
